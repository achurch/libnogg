...
int main(void)
{
    ...
    fclose(f);
    MODIFY(data[0xDFE], 0x00, 0x01);
    MODIFY(data[0xE0F], 0x21, 0xE6);
    MODIFY(data[0xE10], 0xFD, 0x28);
    MODIFY(data[0xE11], 0xFB, 0x09);
    MODIFY(data[0xE12], 0x9F, 0xCB);
    ...
    EXPECT_EQ(vorbis_read_float(vorbis, pcm, 893, &error), 792);
