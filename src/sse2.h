...
#ifndef NOGG_SRC_SSE2_H
#define NOGG_SRC_SSE2_H

/*
 * This header includes the system headers needed for SSE2 intrinsics, and
 * also defines macros to work around incompatibilities between compilers.
 * Sources using SSE2 intrinsics should include this header rather than
 * directly including <xmmintrin.h> or <emmintrin.h>.
 */
